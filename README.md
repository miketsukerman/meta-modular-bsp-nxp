...
|USB1| ⚠️ | USB 3.2 Gen1 detected, plugged-device test ERROR |
|USB2| ⚠️ | USB 2.0 detected, plugged-device test ERROR |
...
|Secure Boot | ⚠️ | Security automated tests OK; Secure Boot flow not explicitly covered |
